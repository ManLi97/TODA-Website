...
// Easing: "entry" = DS --ease-entry curve cubic-bezier(0.16, 1, 0.3, 1) — sharp start, soft landing.
...
export function ScrollReveal({ children, className }: ScrollRevealProps) {
  ...
  useEffect(() => {
    ...
    // SVG path equivalent of CSS cubic-bezier(0.16, 1, 0.3, 1) — DS --ease-entry token
