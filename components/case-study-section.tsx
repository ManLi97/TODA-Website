...
export function CaseStudySection({
  ...
  return (
    <ScrollReveal className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 md:items-start">
      ...
      <div>
        ...
        <p className="text-[24px] md:text-[32px] font-semibold leading-[1.15] tracking-[-0.3px] text-text-primary mb-10">
          {statement}
        </p>
        <div className="space-y-6 mb-8">
          <blockquote className="border-l-2 border-gold-500 pl-4 py-1">
            <p className="text-[18px] md:text-[20px] italic font-normal leading-[1.5] text-text-primary">
              {quote1}
            </p>
          </blockquote>
          <blockquote className="border-l-2 border-gold-500 pl-4 py-1">
